...
class Config(object):
    ...
    def _init_device(self):
        ...
        self.final_config_dict['device'] = torch.device("cuda:"+str(self.final_config_dict['gpu_id']) if torch.cuda.is_available() and self.final_config_dict['gpu_id'] >= 0 else "cpu")
